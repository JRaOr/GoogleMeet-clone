...
export default function TrackVideoParticipant({ participant, index, onlyAudio, dominant }) {
    ...
    return (
        <div className={`rounded-md border-2 ${dominant ? 'border-blue-800' :'border-transparent'} border-transparent overflow-hidden bg-[#36373a] flex items-center justify-center w-full relative max-w-[504px] h-[283px] my-auto mx-auto`}>
